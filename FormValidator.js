...
(function() {
  ...
  FormValidator = (function() {
    ...
    FormValidator.prototype.getAttrQueue = function() {
      var errorMsg, event, flag, input, inputArray, match, regStr, regex, require, validator, validatorStr, _i, _len, _results;
    ...
    FormValidator.prototype.bindSubmit = function() {
      ...
      this.jq(this.form).submit((function(_this) {
        return function() {
    ...
    FormValidator.prototype.bindEventQueue = function(queue) {
      ...
      for (_i = 0, _len = queue.length; _i < _len; _i++) {
        q = queue[_i];
        try {
          _results.push(this.bindEvent(q.tag, this._getEventByItem(q), this._getValidatorByItem(q), q));
        } catch (_error) {
    ...
    FormValidator.prototype.onSubmit = function() {
      var event, q, tag, validator, _i, _len, _ref;
      _ref = this.queue;
